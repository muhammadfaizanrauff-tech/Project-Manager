...
--
-- Generated by concatenating schema-v3.sql, schema-v4.sql, schema-v5.sql and
-- schema-v6.sql, which as of this writing had not been applied to the live
-- database. Every one of them is idempotent, so running this whole file is
-- safe even if some parts were already applied.
--

    ...
    <div className="flex flex-col gap-6">
      ...
      {addingCategory ? (
        ...
        <button
          ...
          className="flex items-center gap-2 self-start rounded-xl border border-dashed px-3 py-2 text-sm text-muted-foreground hover:border-primary/40 hover:text-foreground"
        >

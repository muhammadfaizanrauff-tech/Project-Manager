...
export function ProjectDashboard({
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      <Card className="flex flex-col items-center justify-center gap-2 rounded-2xl p-5 shadow-sm">
        ...
        <div className="relative flex size-24 items-center justify-center">
          ...
          <span className="absolute text-lg font-semibold">{completion}%</span>
        </div>
      ...
      <Card className="gap-3 rounded-2xl p-5 shadow-sm md:col-span-2">
